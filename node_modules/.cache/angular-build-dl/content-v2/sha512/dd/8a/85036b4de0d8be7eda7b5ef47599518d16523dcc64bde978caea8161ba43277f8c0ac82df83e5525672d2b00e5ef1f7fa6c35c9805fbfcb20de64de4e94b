(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["calendar-calendar-module"], {
    ...
    "4vBm":
    /*!******************************************************!*\
      !*** ./src/app/core/pages/calendar/calendar.page.ts ***!
      \******************************************************/
    ...
    function vBm(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_services_calendar_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/shared/services/calendar.service */
      "5To1");
      /* harmony import */


      var src_app_shared_services_ui_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/shared/services/ui.service */
      "8nna");
      /* harmony import */


      var _modals_event_info_event_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../modals/event-info/event.page */
      "6gjK");

      var CalendarPage = /*#__PURE__*/function () {
        function CalendarPage(locale, calService, modalCtrl, uiService) {
        ...
        _createClass(CalendarPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.loadEvent();
            this.calService.newEvent.subscribe(function (ev) {
              _this.allEvents.unshift(ev);
            });
          }
        }, {
          key: "loadEventEdit",
          value: function loadEventEdit(event) {
            console.log(event);
          ...
          value: function loadEvent() {
            ...
            this.calService.getEvents().subscribe(function (resp) {
              _this2.allEvents = [];
              resp.events.forEach(function (event) {
                _this2.allEvents.push({
                  _id: event._id,
                  title: event.title,
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.modalCtrl.create({
                        component: _modals_event_info_event_page__WEBPACK_IMPORTED_MODULE_8__["EventPage"],
                        componentProps: {
                          'event': event
                        }
                      });
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      _context2.next = 4;
                      return this.calService.editEvent(this.newEvent._id, this.newEvent);
                    ...
                    case 8:
                      _context2.next = 10;
                      return this.calService.createdEvent(this.newEvent);
      ...
      CalendarPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function To1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var CalendarService = /*#__PURE__*/function () {
        function CalendarService(http, userService) {
        ...
        _createClass(CalendarService, [{
          ...
          value: function getEvents() {
            ...
            return this.http.get("".concat(URL, "/events/"), {
              headers: headers
          ...
          key: "createdEvent",
          value: function createdEvent(event) {
            var _this3 = this;
            ...
            return new Promise(function (resolve) {
              _this3.http.post("".concat(URL, "/events"), event, {
                headers: headers
              }).subscribe(function (resp) {
                _this3.newEvent.emit(resp['event']);
          ...
          key: "editEvent",
          value: function editEvent(eventId, event) {
            var _this4 = this;

            return new Promise(function (resolve) {
              _this4.http.post("".concat(URL, "/events/update/").concat(eventId), event).subscribe(function (resp) {
                if (resp['ok']) {
                  resolve(true);
          ...
          value: function deleteEvent(eventId) {
            ...
            return new Promise(function (resolve) {
              _this5.http["delete"]("".concat(URL, "/events/delete/").concat(eventId)).subscribe(function (resp) {
                if (resp['ok']) {
                  resolve(true);
    ...
    "6gjK":
    /*!******************************************************!*\
      !*** ./src/app/core/modals/event-info/event.page.ts ***!
      \******************************************************/

    /*! exports provided: EventPage */

    /***/
    function gjK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_event_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./event.page.html */
      "OTDt");
      /* harmony import */


      var _event_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./event.page.scss */
      "ok2p");
      /* harmony import */
      ...
      var _shared_services_calendar_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../shared/services/calendar.service */
      "5To1");
      /* harmony import */
      ...
      var EventPage = /*#__PURE__*/function () {
        function EventPage(locale, calendarService, modalCtrl, alertCtrl, uiService, router) {
        ...
        _createClass(EventPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.startDate = Object(_angular_common__WEBPACK_IMPORTED_MODULE_5__["formatDate"])(this.event.startTime, 'dd-MM-yyy | HH:mm', this.locale);
            this.endDate = Object(_angular_common__WEBPACK_IMPORTED_MODULE_5__["formatDate"])(this.event.endTime, 'dd-MM-yyy | HH:mm', this.locale);
            this.eventModal = {
              _id: this.event._id,
          ...
          key: "deleteEventAlert",
          value: function deleteEventAlert(opt) {
                    ...
                    case 0:
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          text: 'Borrar',
                          handler: function handler() {
                            _this6.calendarService.deleteEvent(_this6.event._id);

                            _this6.modalCtrl.dismiss({
                              option: opt
                            });

                            _this6.uiService.presentToast('Entrenamiento eliminado correctamente.');
                          }
                        }]
                      });
      ...
      EventPage.ctorParameters = function () {
        return [{
          ...
          type: _shared_services_calendar_service__WEBPACK_IMPORTED_MODULE_6__["CalendarService"]
        }, {
          type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"]
        }, {
      ...
      EventPage.propDecorators = {
        event: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"]
        }]
      };
      EventPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-event',
    ...
    "BiRb":
    /*!********************************************************!*\
      !*** ./src/app/core/pages/calendar/calendar.page.scss ***!
      \********************************************************/

    /*! exports provided: default */

    /***/
    function BiRb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "h2 {\n  text-transform: capitalize;\n}\n\nion-label {\n  color: gray;\n}\n\n.indicator-container {\n  padding-left: 0.5rem;\n  padding-right: 0.4rem;\n}\n\n.event-indicator {\n  background: var(--ion-color-soterosport-yellow);\n  width: 5px;\n  height: 5px;\n  border-radius: 5px;\n  display: table-cell;\n}\n\n:host ::ng-deep .monthview-primary-with-event {\n  background-color: var(--ion-color-soterosport-blue) !important;\n}\n\n:host ::ng-deep .calendar-hour-column {\n  width: 40px;\n}\n\n:host ::ng-deep .dayview-allday-label {\n  border: 1px solid #4e4e4e !important;\n  width: 40px;\n}\n\n:host ::ng-deep .weekview-allday-label {\n  border: 1px solid #4e4e4e !important;\n  width: 40px;\n}\n\n:host ::ng-deep .monthview-selected {\n  background-color: var(--ion-color-soterosport-darkyellow) !important;\n}\n\n:host ::ng-deep table,\n:host ::ng-deep tfoot,\n:host ::ng-deep thead,\n:host ::ng-deep tbody,\n:host ::ng-deep tr,\n:host ::ng-deep td,\n:host ::ng-deep th {\n  border: 1px solid #4e4e4e !important;\n}\n\nhr.solid {\n  border-top: 2px solid #bbb;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
      ...
      var DayViewComponent = DayViewComponent_1 = /*#__PURE__*/function () {
        ...
        _createClass(DayViewComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.eventSourceChangedSubscription = this.calendarService.eventSourceChanged$.subscribe(function () {
              _this11.onDataLoaded();
            });
            this.slideChangedSubscription = this.calendarService.slideChanged$.subscribe(function (direction) {
              if (direction === 1) {
                _this11.slider.slideNext();
              } else if (direction === -1) {
                _this11.slider.slidePrev();
              }
            });
            this.slideUpdatedSubscription = this.calendarService.slideUpdated$.subscribe(function () {
              _this11.slider.update();
            });
          }
        }, {
          key: "ngAfterViewInit",
          ...
          value: function onSlideChanged() {
            ...
            this.slider.getActiveIndex().then(function (currentSlideIndex) {
              ...
              if (currentSlideIndex - currentViewIndex === 1) {
                ...
                _this12.slider.slideTo(1, 0, false);
              } else if (currentViewIndex - currentSlideIndex === 1) {
                direction = -1;
              } else if (currentSlideIndex === 2 && currentViewIndex === 0) {
                direction = -1;

                _this12.slider.slideTo(3, 0, false);
              }

              _this12.currentViewIndex = currentSlideIndex;

              _this12.move(direction);
            });
          }
        }, {
          key: "move",
        ...
        _createClass(CalendarComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.currentDateChangedFromChildrenSubscription = this.calendarService.currentDateChangedFromChildren$.subscribe(function (currentDate) {
              _this13._currentDate = currentDate;

              _this13.onCurrentDateChanged.emit(currentDate);
            });
          }
        }, {
          key: "ngOnDestroy",
    ...
    "LWIb":
    /*!**********************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/core/pages/calendar/calendar.page.html ***!
      \**********************************************************************************************/

    /*! exports provided: default */

    /***/
    function LWIb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ion-header class=\"ion-no-border\">\n    <ion-toolbar>\n        <!-- Menu -->\n        <ion-buttons slot=\"start\">\n            <ion-menu-button autoHide=\"false\" menu=\"first\"></ion-menu-button>\n        </ion-buttons>\n        <!-- Título -->\n        <ion-title class=\"ion-text-center\"> Calendario </ion-title>\n        <ion-buttons slot=\"end\">\n            <ion-button>\n                <ion-icon name=\"information-circle-outline\" slot=\"icon-only\"></ion-icon>\n            </ion-button>\n        </ion-buttons>\n    </ion-toolbar>\n</ion-header>\n\n<ion-content>\n    <div *ngIf=\"showAddEvent\">\n        <ion-card class=\"ion-padding\">\n            <ion-item-divider class=\"ion-padding-end\">\n                <h6>Nuevo entrenamiento</h6>\n                <ion-button fill=\"outline\" (click)=\"showHideForm()\" color=\"soterosport-red\" slot=\"end\" size=\"small\">\n                    <ion-icon slot=\"icon-only\" color=\"soterosport-red\" name=\"close\" size=\"small\"></ion-icon>\n                </ion-button>\n            </ion-item-divider>\n\n            <ion-item>\n                <ion-input type=\"text\" placeholder=\"Título\" autocapitalize [(ngModel)]=\"newEvent.title\"></ion-input>\n            </ion-item>\n            <ion-item>\n                <ion-input type=\"text\" placeholder=\"Descripción\" autocapitalize [(ngModel)]=\"newEvent.description\"></ion-input>\n            </ion-item>\n\n            <ion-item>\n                <ion-label><b>Inicio</b></ion-label>\n                <ion-datetime doneText=\"OK\" cancelText=\"Cancelar\" i18n displayFormat=\"DD/MM/YYYY | HH:mm\" pickerFormat=\"MMM D HH:mm\" [(ngModel)]=\"newEvent.startTime\" [min]=\"minDate\"></ion-datetime>\n            </ion-item>\n            <ion-item>\n                <ion-label><b>Fin</b></ion-label>\n                <ion-datetime doneText=\"OK\" cancelText=\"Cancelar\" displayFormat=\"DD/MM/YYYY | HH:mm\" pickerFormat=\"MMM D HH:mm\" [(ngModel)]=\"newEvent.endTime\" [min]=\"minDate\"></ion-datetime>\n            </ion-item>\n\n            <ion-button class=\"ion-padding\" (click)=\"addEvent()\" expand=\"block\" color=\"primary\" [disabled]=\"(newEvent.title.length && newEvent.description.length) < 1\">\n                <ion-icon class=\"ion-margin-end\" name=\"folder-outline\"></ion-icon>\n                Guardar\n            </ion-button>\n        </ion-card>\n    </div>\n\n    <div *ngIf=\"!showAddEvent\">\n        <ion-segment [(ngModel)]=\"calendar.mode\">\n            <ion-segment-button value=\"month\">\n                <ion-label>Mes</ion-label>\n            </ion-segment-button>\n            <ion-segment-button value=\"week\">\n                <ion-label>Semana</ion-label>\n            </ion-segment-button>\n            <ion-segment-button value=\"day\">\n                <ion-label>Dia</ion-label>\n            </ion-segment-button>\n        </ion-segment>\n    </div>\n\n    <ion-row>\n        <ion-col size=\"12\" class=\"ion-text-center\">\n            <h2>{{ currentMonth }}</h2>\n        </ion-col>\n    </ion-row>\n\n\n    <calendar id=\"myCal\" [eventSource]=\"allEvents\" [calendarMode]=\"calendar.mode\" [currentDate]=\"calendar.currentDate\" (onEventSelected)=\"onEventSelected($event)\" (onTitleChanged)=\"onViewTitleChanged($event)\" (onTimeSelected)=\"onTimeSelected($event)\" [step]=\"calendar.step\"\n        [monthviewDisplayEventTemplate]=\"template\" [monthviewEventDetailTemplate]=\"templateItem\">\n    </calendar>\n\n    <ng-template #template let-view=\"view\" let-row=\"row\" let-col=\"col\">\n        <div [class.with-event]=\"view.dates[row*7+col].events.length\">\n            {{view.dates[row*7+col].label}}\n\n            <div class=\"indicator-container\">\n                <div class=\"event-indicator\" *ngFor=\"let e of view.dates[row*7+col].events\"></div>\n            </div>\n        </div>\n    </ng-template>\n\n    <ng-template #templateItem let-selectedDate=\"selectedDate.events\" let-noEventsLabel=\"noEventsLabel\">\n        <hr class=\"solid\" />\n        <ion-item-divider>\n            <h6><strong>Entrenamientos</strong></h6>\n        </ion-item-divider>\n\n        <ion-item *ngIf=\"selectedDate.length === 0\">\n            <p color=\"medium\">Sin entrenamientos para este día</p>\n        </ion-item>\n        <ion-list *ngIf=\"selectedDate.length > 0\" style=\"margin-left: 10px\">\n            <ion-item detail *ngFor=\"let event of selectedDate\" (click)=\"onEventSelected(event)\">\n                <ion-label>{{event.title}}\n                    <p>\n                        {{event.startTime|date: 'HH:mm' }} - {{event.endTime|date: 'HH:mm' }}\n                    </p>\n                </ion-label>\n            </ion-item>\n        </ion-list>\n    </ng-template>\n\n    <!-- Fab button -->\n    <ion-fab *ngIf=\"!showAddEvent\" vertical=\"bottom\" horizontal=\"center\" slot=\"fixed\">\n        <ion-fab-button color=\"soterosport-darkyellow\" (click)=\"showHideForm()\">\n            <ion-icon color=\"soterosport-cream\" size=\"large\" name=\"add\"></ion-icon>\n        </ion-fab-button>\n    </ion-fab>\n</ion-content>";
      /***/
    },
    ...
    "OTDt":
    /*!**********************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/core/modals/event-info/event.page.html ***!
      \**********************************************************************************************/

    /*! exports provided: default */

    /***/
    function OTDt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ion-header>\n    <ion-toolbar color=\"brown\">\n        <ion-title color=\"soterosport-cream\">{{ event.title }}</ion-title>\n        <ion-buttons slot=\"end\">\n            <ion-button color=\"soterosport-cream\" (click)=\"close('close')\">\n                <ion-icon slot=\"icon-only\" name=\"close\"></ion-icon>\n            </ion-button>\n        </ion-buttons>\n    </ion-toolbar>\n</ion-header>\n<ion-content>\n    <ion-card>\n        <ion-card-header>\n            <ion-item class=\"ion-no-padding\">\n                <ion-card-subtitle>Entrenamiento</ion-card-subtitle>\n                <ion-buttons slot=\"end\">\n                    <ion-button (click)=\"editEvent('update')\">\n                        <ion-icon name=\"create-outline\" color=\"primary\"></ion-icon>\n                    </ion-button>\n                    <ion-button (click)=\"deleteEventAlert('delete')\">\n                        <ion-icon name=\"trash-outline\" color=\"soterosport-red\"></ion-icon>\n                    </ion-button>\n                </ion-buttons>\n            </ion-item>\n        </ion-card-header>\n\n        <ion-item>\n            <ion-icon name=\"bookmark-outline\" slot=\"start\" color=\"soterosport-blue\"></ion-icon>\n            <ion-label>{{event.title}}</ion-label>\n        </ion-item>\n\n        <ion-item>\n            <ion-icon name=\"calendar-outline\" slot=\"start\" color=\"soterosport-blue\"></ion-icon>\n            <ion-label>Inicio</ion-label>\n\n            <p>{{startDate}}</p>\n        </ion-item>\n\n        <ion-item>\n            <ion-icon name=\"calendar-outline\" slot=\"start\" color=\"soterosport-blue\"></ion-icon>\n            <ion-label>Fin</ion-label>\n\n            <p>{{endDate}}</p>\n        </ion-item>\n\n        <ion-card-header>\n            <ion-card-subtitle>Descripción</ion-card-subtitle>\n        </ion-card-header>\n\n        <ion-card-content> {{event.description}} </ion-card-content>\n    </ion-card>\n</ion-content>";
      /***/
    },
    ...
    "QCVj":
    /*!****************************************************************!*\
      !*** ./src/app/core/pages/calendar/calendar-routing.module.ts ***!
      \****************************************************************/

    /*! exports provided: CalendarPageRoutingModule */

    /***/
    function QCVj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function UPrT(module, exports, __webpack_require__) {
    ...
    "nObE":
    /*!********************************************************!*\
      !*** ./src/app/core/pages/calendar/calendar.module.ts ***!
      \********************************************************/

    /*! exports provided: CalendarPageModule */

    /***/
    function nObE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _angular_common_locales_es_419__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @angular/common/locales/es-419 */
      "UPrT");
      /* harmony import */


      var _angular_common_locales_es_419__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_es_419__WEBPACK_IMPORTED_MODULE_8__);

      Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["registerLocaleData"])(_angular_common_locales_es_419__WEBPACK_IMPORTED_MODULE_8___default.a);
    ...
    "ok2p":
    /*!********************************************************!*\
      !*** ./src/app/core/modals/event-info/event.page.scss ***!
      \********************************************************/

    /*! exports provided: default */

    /***/
    function ok2p(module, __webpack_exports__, __webpack_require__) {
      "use strict";
